	...
	function sf_theme_options_page() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				settings_fields('sf_theme_options');
				/* This function outputs some hidden fields required by the form, including a nonce, a unique number used to ensure the form has been submitted from the admin page and not somewhere else, very important for security */
				?>
